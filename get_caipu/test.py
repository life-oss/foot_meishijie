...
# 测试正则
# browse_the_number_list = " · 0 收藏 · 3782 浏览"
#
# x = re.sub('\s+|·', '', browse_the_number_list).strip()
# print(x)
# # browse_the_number_match = re.match(r'(?<=藏).+?(?=浏)', str(x))
# browse_the_number_match = re.findall(r'(?<=藏).+?(?=浏)', str(x))
# print(browse_the_number_match[0])
# browse_the_number = browse_the_number_match.group()
# print(browse_the_number)
# dishes_system_list = "山西菜的做法"
